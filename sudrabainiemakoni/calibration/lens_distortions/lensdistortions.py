...
class RationalDistortionLimited(BrownLensDistortionLimited):
    def __init__(self, k1=None, k2=None, k3=None, k4=None, k5=None, k6=None, projection=None):
        self.parameters = ParameterSet(
            # the intrinsic parameters
            k1=Parameter(k1, default=0, range=(0, None), type=TYPE_DISTORTION),
            k2=Parameter(k2, default=0, range=(0, None), type=TYPE_DISTORTION),
...
def distortion_by_name(name):
    ...
    elif name == 'rationaldistortionlimited':
        distortion = RationalDistortionLimited
    else:
