...
class OpenCVBrownLensDistortion(cameratransform.lens_distortion.LensDistortion):
    ...
    def __init__(self, k1=None, k2=None, k3=None, p1=None, p2=None, k4=None, k5=None, k6=None, projection=None):
        """
        ...
        self.parameters = ParameterSet(
            ...
            k4=Parameter(k4, default=0, range=(None, None), type=TYPE_DISTORTION),
            k5=Parameter(k5, default=0, range=(None, None), type=TYPE_DISTORTION),
            k6=Parameter(k6, default=0, range=(None, None), type=TYPE_DISTORTION),
        )
    ...
    def setProjection(self, projection):
        ...
        self.parameters = ParameterSet(
            ...
            k4=self.parameters.parameters["k4"],
            k5=self.parameters.parameters["k5"],
            k6=self.parameters.parameters["k6"],
    ...
    def _update_matrices(self):
        ...
        # Build distortion coefficient vector [k1, k2, p1, p2, k3, k4, k5, k6]
