...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionKalibr_t_kameru.setEnabled(True)
        ...
        self.actionHorizont_lo_koordin_tu_re_is.setEnabled(True)
